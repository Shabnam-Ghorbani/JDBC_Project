package ir.maktab.articleapp.repository;
...
public class ArticleRepository {
    public List<Article> allArticles() throws SQLException {//getAll
    ...
    public Article seeArticleByID(int ID) throws SQLException {//get fetch
