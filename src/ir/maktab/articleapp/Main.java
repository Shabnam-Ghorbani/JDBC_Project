...
import ir.maktab.articleapp.model.entity.Article;
import ir.maktab.articleapp.model.entity.User;
import ir.maktab.articleapp.model.enums.AgeRange;
import ir.maktab.articleapp.repository.ArticleRepository;
import ir.maktab.articleapp.repository.UserRepository;
import ir.maktab.articleapp.service.UserService;
import ir.maktab.articleapp.service.UserServiceImpl;
import ir.maktab.articleapp.util.ApplicationConstant;
...
public class Main {
    ...
    public static void secondMenu() throws SQLException {
        ...
        int value = Integer.parseInt(scanner.nextLine()) - 1;
        SecondMenuOption[] values = SecondMenuOption.values();
        SecondMenuOption nextStep = values[value];
